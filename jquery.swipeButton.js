    ...
    $.fn.swipeDelete = function(o) {
        ...
        return this.filter('[data-swipeurl]').each(function(i, el) {
            ...
            $e.on(o.direction, function(e) {
                ...
                var $li = $(this);
                var cnt = false; //$('.ui-btn', $li).not(".ui-btn-icon-notext").length;
                ...
                if (!cnt) {
                    ...
                    $swipeBtn.prependTo($li.children('h3').children('a')).button();
                    $li.children('h3').children('a').find('.ui-btn').hide().animate({
                        width: 'toggle'
                    }, 200);
